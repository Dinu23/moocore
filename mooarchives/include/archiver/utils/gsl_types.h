...
/* In recent versions of GCC, the inline keyword has two different
   forms: GNU and C99.
...
#ifdef HAVE_INLINE
#  if defined(__GNUC_STDC_INLINE__) || defined(GSL_C99_INLINE) || defined(HAVE_C99_INLINE) || defined(__cplusplus)
...
#define GSL_ERROR_VAL(X, Y, Z) (void)0
#define GSL_ERROR(X, Y) (void)0
